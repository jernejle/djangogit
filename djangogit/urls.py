...
urlpatterns = patterns('',
    ...
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/addfiles/$', 'repocontrol.views.addfiles'),
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/download/$', 'repocontrol.views.download'),
    ...
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/commit/(?P<sha>[0-9a-f]{5,40})/deletecomment/(?P<commentid>\d+)/$', 'repocontrol.views.deletecomment'),
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/commit/(?P<sha>[0-9a-f]{5,40})/editcomment/(?P<commentid>\d+)/$', 'repocontrol.views.editcomment'),
    ...
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/issues/(?P<keyid>\d+)/changelabel/$', 'issues.views.changelabel'),
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/issues/(?P<keyid>\d+)/deleteissue/$', 'issues.views.deleteissue'),
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/issues/(?P<keyid>\d+)/edit/$', 'issues.views.edit'),
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/issues/(?P<keyid>\d+)/editcomment/(?P<commentid>\d+)/$', 'issues.views.editcomment'),
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/issues/(?P<keyid>\d+)/removecomment/(?P<commentid>\d+)/$', 'issues.views.removecomment'),
    ...
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/graphs/$', 'repocontrol.views.graphs'),
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/graphs/commits-history/$', 'repocontrol.views.commits_history'),
    url(r'^(?P<userid>\d+)/(?P<slug>[a-zA-Z0-9_-]+)/graphs/committers-history/$', 'repocontrol.views.committers_history'),
