...
DATABASES = {
    'default': {
        ...
        'NAME': '%s/../db/db.sqlite' % ROOT,                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '@!a_bd9^$m)p6f6rq2732yher$jmxwl_qjpz5g76#9r9rr1v8&amp;'
...
INSTALLED_APPS = (
    ...
    'userprofile','repocontrol','issues',
    'dajaxice','dajax',
)
